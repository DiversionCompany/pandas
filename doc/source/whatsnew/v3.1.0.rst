...
- Performance improvement in :attr:`Timedelta.seconds` and :attr:`Timedelta.microseconds` by using precomputed struct fields instead of recomputing from component fields (:issue:`57951`)
