...
- Bug in :func:`read_sql` where DBAPI2 cursors using a dict-based row factory (e.g. ``pymysql`` with ``DictCursor``) returned incorrect or missing values because rows returned as dicts were not handled correctly (:issue:`53028`)
