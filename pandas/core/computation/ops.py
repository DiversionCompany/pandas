...
class Term:
    ...
    def _resolve_name(self):
        ...
        # Only override is_local when the user did NOT explicitly use the '@'
        # prefix. If '@name' was used, respect the explicit local-scope lookup.
        # GH#48694: do not override is_local for explicitly-referenced names.
        explicitly_local = str(self.name).startswith(LOCAL_TAG)
        if (
            not explicitly_local
